...
SWEP.PrintName                  = "Shuriken"    
 if (SERVER) then
 	resource.AddFile("materials/vgui/ttt/icon_shuriken.png")
	resource.AddFile("models/v_shuriken.mdl")
	resource.AddFile("models/w_shuriken.mdl")
	resource.AddFile("models/w_shuriken.mdl")
	resource.AddFile("models/shuriken_small.mdl")
	...
	resource.AddFile("materials/brass.vmt")
	resource.AddFile("materials/shuriken.vmt")
...
SWEP.ViewModel    = Model("models/v_shuriken.mdl")
SWEP.WorldModel   = Model("models/w_shuriken.mdl")
 
 
 
SWEP.Kind = WEAPON_EQUIP
 
SWEP.Icon = "vgui/ttt/icon_shuriken.png"
...
function SWEP:PrimaryAttack()
		if (self:CanPrimaryAttack()) then
				...
				if SERVER then
						...
						shuriken:SetAngles(self.Owner:EyeAngles())
